...
public slots:
    void getHistory(bool force);
    void buy(QString symbol, double apiBtcToBuy, double apiPriceToBuy);
    void sell(QString symbol, double apiBtcToSell, double apiPriceToSell);
    void cancelOrder(QString symbol, QByteArray order);
};
